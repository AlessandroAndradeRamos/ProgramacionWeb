...
let climaPromesa = new Promise (function(resolve, reject){
...
climaPromesa.then(function () {
    console.log('Exito toal, todo el clima siempre bien :)');
}).catch(function () {
    console.log('Puros fallos siempre, salio un error lo siento companero');
});